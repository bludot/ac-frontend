 ...
 */
    ...
    if (this.props.cursor) {
      ...
      ctx.shadowColor = "rgba(0,0,0,0.25)";
      ctx.shadowBlur = 5;
      ctx.lineWidth = this.lineWidth + 150 * this.props.thickness;
      ctx.arc(
        this.xy,
        this.xy,
        this.radius - 30,
      ...
      ctx.arc(
        this.xy+((this.radius-30) * Math.cos(a.endAngle)),
        this.xy+((this.radius-30) * Math.sin(a.endAngle)),
        20,
        0,
        360,
        a.acw
      ...
      var gradient = ctx.createRadialGradient(
        this.xy+((this.radius-30) * Math.cos(a.endAngle)) - 10,
        this.xy+((this.radius-30) * Math.sin(a.endAngle)) - 10,
        0,
        this.xy+((this.radius-30) * Math.cos(a.endAngle)),
        this.xy+((this.radius-30) * Math.sin(a.endAngle)),
        20
      ...
      >
        <canvas
          ...
          style={{
            ...
            height: "100%",
            borderRadius: "100%",
            boxShadow: "inset 0px 0px 20px -10px rgba(0,0,0,0.25)",
            background: "white",
            zIndex: 1
          }}
