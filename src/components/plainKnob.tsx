...
class Knob extends React.Component {
  ...
  drawCanvas() {
    ...
    if (this.props.cursor) {
      ...
      ctx.strokeStyle = "red";
      console.log(this.coerce, this.val);
      console.log(this.getArcToValue(this.val));
      const data = this.getArcToValue(this.val);
      ctx.arc(data.startAngle, data.endAngle, 10, 0, 360, false);
